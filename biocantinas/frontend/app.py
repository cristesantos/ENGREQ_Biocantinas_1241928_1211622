...
elif pagina == "Administrador" and str(st.session_state.user_info.get("role", "")).upper() == "ADMIN":
...
elif pagina == "Gestor Cantina Central" and str(st.session_state.user_info.get("role", "")).upper() == "GESTOR_CANTINA_CENTRAL":
